"""
Django settings for issfwr project.
...
WSGI_APPLICATION = "issfwr.wsgi.application"


# Database
# https://docs.djangoproject.com/en/5.0/ref/settings/#databases

DATABASES = {"default": dj_database_url.config(default=decouple.config("DATABASE_URL"))}
